...
const Reocurance = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    x="0px"
    y="0px"
    className={`agi-svg svg-reocurance ${className}`} { ...qa('svg-reocurance') }
...
Reocurance.propTypes = {
  className: PropTypes.string,
};

Reocurance.defaultProps = {
  className: '',
};

export default Reocurance;
