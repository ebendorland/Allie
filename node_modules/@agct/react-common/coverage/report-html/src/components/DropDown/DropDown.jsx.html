...
<html lang="en">
<head>
    <title>Code coverage report for src/components/DropDown/DropDown.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">src/components/DropDown/</a> DropDown.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
var getPrompt = function getPrompt(prompt, selectedItem, upper) {
  var promptText = selectedItem ? <span class="branch-0 cbranch-no" title="branch not covered" >selectedItem.label </span>: prompt;
  return upper ? <span class="branch-0 cbranch-no" title="branch not covered" >promptText.toUpperCase() </span>: promptText;
};
&nbsp;
...
&nbsp;
  _createClass(DropDown, [{
    ...
    value: function handleToggle(evt) {
      evt.preventDefault();
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.props.isDisabled) {
        this.props.onFocus();
    ...
    key: 'handleSelect',
    value: <span class="fstat-no" title="function not covered" >function handleSelect(item) {</span>
<span class="cstat-no" title="statement not covered" >      var value = item.value || item || null;</span>
<span class="cstat-no" title="statement not covered" >      this.props.onChange(value, item);</span>
<span class="cstat-no" title="statement not covered" >      this.props.ui.close();</span>
    }
  }, {
    key: 'render',
    value: function render() {
      var _this2 = this;
&nbsp;
      var selectedItem = this.props.value ? <span class="branch-0 cbranch-no" title="branch not covered" >_lodash2.default.find(this.props.items, <span class="fstat-no" title="function not covered" >function (i) {</span></span>
<span class="cstat-no" title="statement not covered" >        return i.value === _this2.props.value;</span>
      }) : null;
      var blankOption = this.props.withBlank &amp;&amp; (0, _DropDownUtils.buildBlankOption)(this.handleSelect);
      var flatOptions = this.props.items &amp;&amp; (0, _DropDownUtils.buildOptions)(this.props.items, selectedItem, this.handleSelect);
&nbsp;
      var toggleCssClasses = (0, _classnames2.default)('btn dropdown__toggle', {
...
&nbsp;
      var prompt = getPrompt(this.props.prompt, selectedItem, this.props.promptUpperCase);
&nbsp;
      return _react2.default.createElement(
        'div',
        _extends({ className: 'dropdown' }, (0, _qa.attr)('dropdown')),
        _react2.default.createElement(
          'div',
          { className: toggleCssClasses, onClick: function onClick(evt) {
              return !_this2.props.isDisabled &amp;&amp; _this2.handleToggle(evt);
            } },
          _react2.default.createElement(
            'span',
...
DropDown.propTypes = {
  ...
  promptUpperCase: _react.PropTypes.bool,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jan 13 2017 16:15:56 GMT+0000 (UTC)
</div>
</div>
